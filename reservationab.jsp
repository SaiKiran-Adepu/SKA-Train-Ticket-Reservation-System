...
<%
   //String uname = request.getParameter("");
       ...
       // String s = request.getParameter("SOURCE");
        ...
        int usrn=Integer.parseInt(request.getParameter("usrn"));
        ...
        ps2.setString(2,d);
          ...
          out.println("<form method = post onSubmit=return login(this) action = reservationacnf.jsp>");
         //int cnt=rs;          
         while(rs.next())
         {
              out.println("<center>");
  ...
  out.println("<tr>");
              ...
              while(rs1.next())
        {
         ...
         switch(ch) {
          ...
          String name2=(String)session.getAttribute("adm");
                //out.println(name2);
                  out.println("<td><textarea rows1 cols=15 name=usr readonly>"+usrn+"</textarea></td>");//booked by from admin side
                 out.println("<td><textarea rows1 cols=15 name=adm1 readonly>"+name2+"</textarea></td>");//booked by from admin Window
                 
        //out.println("<");//onSubmit=return login(this)
                 out.println("<td><input type = submit value=BOOK TICKET onClick =login(this.form)>&nbsp&nbsp<input type=button value=BACK onclick=history.back()></td>");
                 out.print("</form>");
