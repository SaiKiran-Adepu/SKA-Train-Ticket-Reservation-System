...
<html lang="en">
    <head>
        <title>ADMIN DELETE FEEDBACKS</title>
    ...
    <body>
	<center>
        <form method = "post" onSubmit="return login(this)" action = "adfeedelb.jsp">
            <fieldset style="width:30%; background-color:lightblue">
                <h3><center>ADMIN DELETE FEEDBACK</center></h3>
                <hr>
                <table>
                    <tr>
                        <td>FEEDBACK NUMBER<font color="red">*</font>:</td>
                        <td> <input type = "number" name = "fnd" id="fn" Placeholder="FEEDBACK NUMBER"></td>
                    </tr>
