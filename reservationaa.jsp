...
<html lang="en">
    ...
    function login(form)
	{
		...
		//var usrn = document.getElementById("usrn").value; not manadatory because no acount user also reserved...
...
BERTH:<select id="berth" disabled name="berth">
 ...
 <tr>
	...
	<td><br>USER NUMBER:<input type="text" name="usrn" placeholder="If Register"></td>		  
