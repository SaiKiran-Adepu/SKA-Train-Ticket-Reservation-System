			...
			<td>
				<form name=F1 method="post" onSubmit="return dil(this)" action="newtrainb.jsp" >
				  <table cellspacing="5" cellpadding="3">
				   ...
				   <tr><td>T NUMBER<font color="red">* </font>:</td><td> <input type="number" name="trainnumber" id="trainnumber" Placeholder="Train Number"/></td></tr>
				   <tr><td>T NAME<font color="red">* </font>:</td><td> <input type="text" name="trainname" id="trainname" Placeholder="Train Name"/></td></tr>
					  <tr><td>STATIONS<font color="red">* </font>:</td><td> <input type="text" name="stations" id="stations" Placeholder="Stations"/></td></tr>
