...
<%
   ...
   switch(ad) {
         ...
         out.println("<td><textarea rows1 cols=15 name=rs readonly>"+s1+"</textarea></td>");
                 ...
                 out.println("<td><textarea rows1 cols=15 name=dc readonly>"+dc+"</textarea></td>");
        out.println("<td><input type = submit value=CUT onClick =login(this.form)><br>&nbsp<input type=button value=BACK onclick=history.back()></td>");
        //out.println("<td><</td>");
